...
# output = [(x, len(x)) for x in text.split()]  # TODO: punctuation messes up word count, can remove with nested comprehension
output = {(x, len(x)) for x in text.split()}  # set comprehension - removes duplicates!
print(output)