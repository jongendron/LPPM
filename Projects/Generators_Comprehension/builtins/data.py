...
# They are lightweight and use little to no more data than regular tuples

# Plant = namedtuple('Plant', ['name', 'scientific_name', 'lifecycle', 'plant_type'])  # <tuple name> <list of names for tuple fields>
Plant = namedtuple('Plant', 'name, scientific_name, lifecycle, plant_type')  # works same
