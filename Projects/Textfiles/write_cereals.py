# -*- coding: utf-8 -*-
"""
Created on Fri Feb  3 15:42:28 2023
...
#%% write a csv to file
# writerows() will iterate over a nested list for you
# writerow() requires you iterate yourself and index each list yourself
with open(output_filename, 'w', encoding='utf-8', newline='') as output_file:
    ...
    writer.writerows(cereals) # iterates over items passed to created formated csv row for each element
