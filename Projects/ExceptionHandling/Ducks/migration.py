...
flock.add_duck(percy) # Causes AttributeError when using migrate method w/o exceptions
flock.migrate() # AttributeError evoked and causes program to crash w/o exceptions
