...
#         #items.remove(restricted_item) # remove will cause error
# 
# =============================================================================
    #items -= restricted_items # set difference more efficient
...
# more efficient to just use set difference operation